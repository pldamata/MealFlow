/*
  # Initial Schema Setup for MealFlow

  1. New Tables
    - tenants: Store tenant information
    - users: User management
    - dining_halls: Restaurant/cafeteria locations
    - meal_periods: Service periods (breakfast, lunch, etc.)
    - meals: Available meal options
    - meal_plans: Daily meal planning
    - consumers: End users who make reservations
    - reservations: Meal bookings
